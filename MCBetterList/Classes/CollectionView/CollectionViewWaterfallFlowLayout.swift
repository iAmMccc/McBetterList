...
public protocol BTCollectionViewWaterfallFlowLayoutDataSource: NSObjectProtocol {
    /// 获取item的高度
    func waterfallLayout(_ layout : CollectionViewWaterfallFlowLayout, heightForRowAt indexPath : IndexPath) -> CGFloat
    /// 需要展示多少列
    func waterfallLayout(columnCountOfLayout layout : CollectionViewWaterfallFlowLayout) -> Int
}
